...
export const DEFAULT_LIMITS_BUFFER_MULTIPLIERS = {
  [TOKEN_SYMBOLS_MAP.DAI.symbol]: "0.8",
  [TOKEN_SYMBOLS_MAP.USDT.symbol]: "0.8",
  [TOKEN_SYMBOLS_MAP.WBTC.symbol]: "0.8",
  [TOKEN_SYMBOLS_MAP.USDC.symbol]: "0.2",
  [TOKEN_SYMBOLS_MAP.ETH.symbol]: "0.2",
  [TOKEN_SYMBOLS_MAP.WETH.symbol]: "0.2",
};
